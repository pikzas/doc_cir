...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch" action="<c:url value='/back/softinfo/querySoftwareAndSfhistory.do'/>" method="post">
	...
	<table class="table table-bordered table-hover table-striped table-top" data-selected-multi="true">
		...
		<tbody>
			...
			<c:if test="${not empty po and po.total eq 0}">
				<tr>
					<td colspan="9" style="color:red;text-align:center;font-size:14;">没有该记录信息</td>
				</tr>
			</c:if>
		</tbody>
	</table>
