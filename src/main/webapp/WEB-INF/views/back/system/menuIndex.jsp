		...
		<header id="bjui-header">
			...
			<nav id="bjui-navbar-collapse">
				<ul class="bjui-navbar-right">
					...
					<li><a href="#"><font color="red">Hi</font>&nbsp;<i class="fa fa-male"></i> ${admin.relName}<span class="badge"></span></a></li>
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown">
							我的账户
							<span class="caret"></span>
						</a>
						<ul class="dropdown-menu" role="menu">
							<li><a href="<c:url value="/back/system/saveAdminAuditForm.do"/>" data-toggle="dialog" data-width="800" data-height="400">
									&nbsp;
									<span class="glyphicon glyphicon-user"></span>
									我的资料
								</a></li>
							<li class="divider"></li>
							<li><a href="<c:url value="/system/logout.do"/>" class="red">
									&nbsp;
					...
					<li class="dropdown"><a href="#" class="dropdown-toggle theme blue" data-toggle="dropdown" title="切换皮肤">
						...
						<ul class="dropdown-menu" role="menu" id="bjui-themes">
							...
							<li class="active"><a href="javascript:;" class="theme_blue" data-toggle="theme" data-theme="blue">
			...
			<div id="bjui-hnav">
				...
				<div id="bjui-hnav-navbar-box">
					<ul id="bjui-hnav-navbar">
						<c:forEach items="${sessionScope.menus1}" varStatus="s" var="info">
						<li class="active">
							<a href="javascript:;" data-toggle="slidebar">
								<i class="fa fa-table"></i>${info.name}
							</a>
							<div class="items hide" data-noinit="true">
								<c:forEach items="${info.children}" varStatus="s2" var="info2">
									<ul class="menu-items" data-tit="${info2.name}" data-faicon="table">
										<c:forEach items="${info2.children}" varStatus="s3" var="info3">
											<li><a href="<c:url value="${info3.url}"/>" data-options="{id:'${info3.description}', faicon:'th-large', fresh:true}">${info3.name}</a></li>
<%--
											<li><a href="<c:url value="${info3.url}"/>" data-options="{id:'djc-list', faicon:'th-large', fresh:true}">${info3.name}</a></li>
--%>
										</c:forEach>
									</ul>
								</c:forEach>
				...
				<div class="tabsPageHeader">
					<div class="tabsPageHeaderContent">
						<ul class="navtab-tab nav nav-tabs">
							<li data-url="<c:url value="/system/default.do"/>" data-faicon="home"><a href="javascript:;">
									<span>
