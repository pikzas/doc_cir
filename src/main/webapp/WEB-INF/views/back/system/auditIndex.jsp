        ...
        <div id="bjui-hnav">
            ...
            <div id="bjui-hnav-navbar-box">
                <ul id="bjui-hnav-navbar">
                	<li class="active"><a href="javascript:;" data-toggle="slidebar"><i class="fa fa-check-square-o"></i>入库管理</a>
            ...
            <div class="tabsPageHeader">
                <div class="tabsPageHeaderContent">
                    <ul class="navtab-tab nav nav-tabs">
                        <li data-url="<c:url value="/system/default.do"/>" data-faicon="home" data-options="{fresh:true}"><a href="javascript:;"><span><i class="fa fa-home"></i> #maintab#</span></a></li>
                    </ul>
                </div>
