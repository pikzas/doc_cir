...
<div class="bjui-pageHeader">
	<form id="pagerForm" data-toggle="ajaxsearch"
		...
		<div class="bjui-searchBar">
			...
			<button style="float:right;" type="button" class="btn-blue" data-confirm-msg="确定要删除吗？" data-idname="expids" data-group="ids"  data-icon="fa-trash" onclick="batchDelete()">批量删除入库信息</button>
